...
export const items = {
  ...
  621: 'The computer opponent taught to answer a torpedo, and a check that keeps its orders in step with yours',
  703: 'The last three orders a player can give that the computer opponent still cannot',
  698: 'The computer opponent bringing its torpedo boat to the fight, instead of almost never building one',
