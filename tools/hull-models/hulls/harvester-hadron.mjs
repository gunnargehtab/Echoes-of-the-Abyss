...
// The seams at the file's 1.6, on the navy's near-black base since #888:
// the approved export had them as the crystal-glow token through and
// through (#C9A6FF under #C9A6FF at roughness 0.3), one name at two values
// across the navy. The emissive did not move, so the strength is the file's.
