 ...
 * `algae_membrane` part is (factions/pelagia.mjs): #891 checked the four
 ...
 * fringe the closed chitin orbs show too, and a 3-px see-through at the
 * bow tip where the pod's lathe is open at its point (`loft` caps no
 * end), no valve and older than this. Each shell's one open edge is its
 * equator, facing down, and it nests 4 % proud of a closed lobe: there is
 * no hole to see into from above the waterline.
 *
