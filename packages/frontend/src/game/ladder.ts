 ...
 * floor, and in every palette it lifts black ground less than every rung-5
 * outline at its loudest does. ladder.test.ts records both. Settling them is the owner's call, and
