...
| --- | --- | --- | --- |
| Abyssal Submersible — the intake | 12 | **SIG 22 idle / 28 cruise · HYD 85 · PR-3 · 520 HP · 80 dmg at 650 m** ([units.md](units.md)) | The faction's deep hull, and the year's own. PR-3 covers every metre this map authors, so nothing here crushes anybody. Not the Chorister, the cohort hull the roster carries since #352: at 50 m it is beneath a Sounder's notice ([bestiary.md](bestiary.md) §4), and a mission whose one lethal thing is a colossus needs a hull the colossus grinds |
...
2. **No reinforcement.** Twelve is the year. A cohort economy that could replace what it spent
   would teach a different lesson than the one §6 row 2 names — and the roster can price the
   replacement now (§13), which is exactly why the mission does not offer it.
...
order banks 218.75 from seven and answers the band from the eighth; twelve hulls in twelve places
are never more than 56 in any cell and wear nothing by moving, and what a kill takes the ground
has back in about three and a half minutes. That is the price under "the intake is not a fleet, it
is an array", and it is the one number in this movement the mission does not say: the ground
rewards the spread and does not explain why (§10). §13 carries the decision to leave it unsaid,
...
- A Hollow has **640 HP**, deals **55/s** inside 110 m, and lunges at 75 m/s — faster than the
  intake's 60.
- An Abyssal Submersible has **520 HP** and deals **80 every 2.7 s** — 29.6/s — out to 650 m.
...
killed — not for its 9,000 HP, which twelve intakes at 29.6/s each would have through in
twenty-five seconds, but because the transit is a beat and a driven creature takes no weapon damage
...
against a Corvette's 80 and a Light Scout's 60. The Directorate's deep hull is the smallest thing
in the game a colossus grinds through, and it is the one on this map — the Chorister, at 50 m, is
beneath its notice, which is the second reason §2 fields the year in Submersibles. Nothing had to
be added for the mission to have a lethal threat; the roster already had one, aimed at exactly
this faction.
...
- **[units.md](units.md)** — the Abyssal Submersible, its 95 metres, and the Chorister this mission fields none of
