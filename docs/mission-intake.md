...
somebody writes its literal, and unlike [mission-thin-water.md](mission-thin-water.md)'s it did
**not** answer "nothing new": this is the mission that found out the format could not price an
economy that is not Nodules. That row has since been built (#330); the literal has not.
