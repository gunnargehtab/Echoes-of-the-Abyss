...
table also carries two findings the literal makes against the engine as built, in the manner of
§3's note: the colossus, which it does not settle (#349), and the region ledger, which #350 settled
in this document rather than in the engine.
