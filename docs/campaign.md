...
**29 missions.** The order is free after the prologue. The design intends the game to track what you have already seen — replaying a scene you witnessed from the other side would change the briefing text, never the mission — and the record that tracking stands on is now built (§11); the briefing variants that read it are not.
...
| 4 | **[Deep Furrow](mission-deep-furrow.md)** | Seeding, terraforming, +1 PR zones | You make a piece of the Abyssal habitable. It is genuinely beautiful and it is genuinely a provocation. Specified in full in [mission-deep-furrow.md](mission-deep-furrow.md) |
| 5 | **[In Writing](mission-in-writing.md)** | Spore Veil against the best listeners in the game | The Directorate's 205 PC letter stops being a document. Specified in full in [mission-in-writing.md](mission-in-writing.md), on *Deep Furrow*'s ground unchanged |
| 6 | **[Radicals](mission-radicals.md)** | Fighting your own faction's momentum | Anholt's people move without consensus. Marr will not stop them. You are asked to escort what you voted against. Specified in full in [mission-radicals.md](mission-radicals.md) |
| 7 | **[The Second Seeding](mission-second-seeding.md)** | Everything at once | The rim. Gardening, at the site four armies are converging on. Specified in full in [mission-second-seeding.md](mission-second-seeding.md) — the Commune's convergence slot and its ending in one mission (§8, §9) |
...
| 3 | **[The Dome](mission-the-dome.md)** | Cantors, listening domes, Chorus Call | You spoof an army. It works perfectly and teaches you what your own ears are worth. Specified in full in [mission-the-dome.md](mission-the-dome.md) |
| 4 | **[Shallow](mission-shallow.md)** | Your own weakness | Above 400 m: −20% speed, −15% HP. The most feared army in the Rift, losing to altitude. Specified in full in [mission-shallow.md](mission-shallow.md) |
| 5 | **[Trench Awakening](mission-trench-awakening.md)** | Megafauna, fauna aggro, Biomass | You call something and you do not steer it ([bestiary.md](bestiary.md)). Specified in full in [mission-trench-awakening.md](mission-trench-awakening.md) |
| 6 | **[Conclave](mission-conclave-attending.md)** | Fighting with half an army | First Cantor Ossary does not move against Korrin directly. He simply does not move. Specified in full in [mission-conclave-attending.md](mission-conclave-attending.md), whose `attending-` prefix is the whole of what distinguishes it from the Order's *Conclave* in §7 (§1) |
| 7 | **[First Arrival](mission-first-arrival.md)** | Information into tempo | Arrive at the rim before anyone. Hold it with the slowest units in the game. Specified in full in [mission-first-arrival.md](mission-first-arrival.md) — the Directorate's convergence slot and its ending in one mission (§8, §9) |
...
| 3 | **[Nineteen](mission-nineteen.md)** | Permanent loss | The 211 PC cadre. Every unit lost in this mission is gone for the rest of the campaign. Specified in full in [mission-nineteen.md](mission-nineteen.md), which is also where the carry it asks for is recorded as unbuilt |
| 4 | **[Conclave](mission-conclave-chord.md)** | Nothing new — a defensive mission you are meant to almost lose | Chapter-Master Vrey has the standing to call a vote. He does not. He wants Sull to hear him not do it. Specified in full in [mission-conclave-chord.md](mission-conclave-chord.md), the Order's *Conclave* and not the Directorate's in §6, which the `chord-` prefix is the whole of what separates them by (§1) |
| 5 | **[The Three](mission-the-three.md)** | Nothing at all | A quiet mission at 2,900 m. You escort Sull to the mute technicians. Twelve minutes, no combat, and the transcripts. Specified in full in [mission-the-three.md](mission-the-three.md) |
| 6 | **[The Rim Deposits](mission-rim-deposits.md)** | Raiding, extraction under fire | The crystal exists in exactly one place. Sull authorises the plan. Specified in full in [mission-rim-deposits.md](mission-rim-deposits.md) — the Order's convergence slot (§8) |
| 7 | **The Second Chord** | Resonance Collapse, and a 30 s SIG 100 emission | You transmit. The reply is not shown. The one row of §5–§7 still without a document of record — the Order's ending (§9), and `mission-second-chord.md` is a stub the other thirteen link forward to |
...
| **The other three campaigns** — 21 missions | **First missions specified and built** ([mission-tend.md](mission-tend.md), [mission-attendance.md](mission-attendance.md), [mission-aptitude.md](mission-aptitude.md)) — Aptitude last, and with it every mission the bible had specified had a literal behind it. **[Thin Water](mission-thin-water.md) was the first document past that line and is now built as well** — `kell-shoulder` and `seeding-thin-water`, with tests — and its §13's prediction held: the escort hold, `souls`, the emitter window and the condition-fired beat all already shipped, and the one thing the literal wanted that the document had not anticipated was a second terminal row, because the outcome ladder is read off how many terminal objectives were met and its §8 Results table has three rows. **[Intake](mission-intake.md) followed, and is built as well** — `banding-ground` and `attending-intake`, with tests — and it broke Thin Water's streak twice: its §13 had already found the first thing a specified mission wanted and did not have since the Ledger's three additions, a predicate over Biomass, which landed ahead of the literal (#330) as `deliver` generalised over the economy record's three accounts; and the literal then found four more, each a rule that was right for a court and wrong for a shift — a mission that runs its length whatever the register stands at, `survive` as a standing count, an objective not scored before it is revealed, and a transit with a depth. Its §13 also carries two findings against the roster it does not settle: twelve live guns bring the colossus down, and the region ledger discounts a rendering. **[Standing Wave](mission-standing-wave.md) is the queue behind it: specified and not built.** Standing Wave asks for a great deal more: its §13 was the first that is a design agenda rather than a build list, headed by a docs-versus-code disagreement it deliberately did not settle — the corridor's PF 2.0 against `MAX_PROPAGATION_FACTOR`, which is 1.60 and derived. **That call and the build-radius one beside it are now made** (#372): the corridor keeps 2.0, carried by a ceiling the map reports about itself so only a standing corridor pays for it, and the build radius is 1,500 m — the pairing range — for every structure. What the literal still wants is a predicate over what the player has built, which the objective union has never carried, and its §13's other rows. **[Convocation](mission-convocation.md) was the queue behind that and is now built as well** — `seeding-convocation` on `marr-plateau`, with tests — and it was the second document whose §13 was partly a design agenda rather than a build list. All four rows of that agenda landed together, because the document required it: the **walk** (an ordered set of held positions with a ceiling on the row's own water rather than a floor on the hull's SIG, and a stall when a hull of another party is standing in it), the **restart** (the first mechanic in this game that takes progress back — the `walk` predicate is the first counter in the objective union that can go down), the **commander ability the format had never carried at all**, and the **Holdfast held**, which was the walk's stall with the sign flipped and shares its one call. The ability is a grant rather than a lock and so is its own type beside `MissionAbility`, with Marr's radius, bonus and duration in `constants.ts` as SPEC against [characters.md](characters.md) and the bell's SIG 70 left in the literal where the mission document put it. Two findings the literal produced that the document had not anticipated: campaign.md §10's telegraph is measured between two authored ticks and a failure by *hold* has one, so the rule is paid out of the hold's own sixty seconds and the test enforces that instead; and a walk needs a marker that **moves**, which an objective's single `markerId` cannot express, so the live row ships its own and the rest of the circuit stays off the wire. It is also the first mission written on ground another mission already uses — `marr-plateau`, unchanged from [mission-tend.md](mission-tend.md) — and the registry needed nothing for that, so §2 rule 5 now has its concrete pair and still no mechanism. Its §13 keeps one question deliberately unsettled — whether the count read at the watch's edge and the active ping should be the same act — and the build did not need to settle it. **Thirteen of the other 14 rows of §5–§7 now have a document of record, and none of the thirteen has a literal.** The Commune's [Deep Furrow](mission-deep-furrow.md), [In Writing](mission-in-writing.md), [Radicals](mission-radicals.md) and [The Second Seeding](mission-second-seeding.md); the Directorate's [The Dome](mission-the-dome.md), [Shallow](mission-shallow.md), [Trench Awakening](mission-trench-awakening.md), [Conclave](mission-conclave-attending.md) and [First Arrival](mission-first-arrival.md); the Order's [Nineteen](mission-nineteen.md), [Conclave](mission-conclave-chord.md), [The Three](mission-the-three.md) and [The Rim Deposits](mission-rim-deposits.md) — each linked from its row in §5–§7, each with the thirteen sections the pattern has, and each with a §13 that is a build list rather than prose. What that changes about this table is the shape of the remaining work: the campaign's gap is now literals and not specification. The fourteenth row, *The Second Chord*, is the one still without a document. None of the thirteen has been read against the registry, and the format has moved four times since Intake — the Biomass predicate (#330), the PF ceiling and build radius (#372), the walk, restart and commander ability (#373), and the progression record (#371) — so each §13 is written against a moving target and is worth re-reading at the moment its literal is started, not before |
| **Convergence — The Rim** | **One of four built, and all four now specified** — the Ledger's is built, as [mission-prospect.md](mission-prospect.md); the other three are documents without literals: [mission-second-seeding.md](mission-second-seeding.md), [mission-first-arrival.md](mission-first-arrival.md) and [mission-rim-deposits.md](mission-rim-deposits.md). They reach the same eleven kilometres from their own directions, per §8's rule that it is never the same mission, and each names its tide of the rim week — *Prospect* and *The Second Seeding* on D, from opposite sides of the same day; *First Arrival* on D+1; *The Rim Deposits* on D+2; the Order's ending on D+3 — so that no document shows another campaign's army on a tide that campaign does not put it there |
| **The four endings** | **One of four built, three of four specified** — the Ledger's is built, as [mission-item-nine.md](mission-item-nine.md): one conclusion outcome, two unranked records, which is §9 kept mechanically. The Commune's and the Directorate's are documents without literals and are the same missions as their convergence slots ([mission-second-seeding.md](mission-second-seeding.md), [mission-first-arrival.md](mission-first-arrival.md)), each keeping §9's refusal to rank in its own faction's grammar. The Order's, *The Second Chord*, is the row without a document |
...
| The three systems that stand on that record — briefing variants (§1), cross-mission Drift Health (§2 rule 5), permanent roster attrition | Not started. Each is a sibling key beside `missions` in the same record, which is why it is a container of collections rather than a flat map: a key that does not exist yet reads as empty, and no first version needs a migration story |
