...
| **The other three campaigns** — 21 missions | **First missions specified and built** ([mission-tend.md](mission-tend.md), [mission-attendance.md](mission-attendance.md), [mission-aptitude.md](mission-aptitude.md)) — Aptitude last, and with it every mission document in the bible has a literal behind it. Its §13 keeps the three rows that are still owed, none of which stops it being played; the other 18 rows of §5–§7 remain titles, teaching targets and beats, and each needs a document of its own before it needs code |
