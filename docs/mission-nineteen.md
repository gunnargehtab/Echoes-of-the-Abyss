...
and the only trench-cohort the bible numbers by name belongs to another campaign's seeding week; a
second numbered trench authored here would be a Directorate fact invented from the wrong side of
the water.
...
| Campaign progression | **Not started** ([campaign.md](campaign.md) §11). The row above depends on it, Sull's authorisation in mission 6 depends on this tide having happened, and neither is carried by anything |
