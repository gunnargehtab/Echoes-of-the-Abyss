...
> The third mission of the Knight campaign ([campaign.md](campaign.md) §7), specified — and one
> of the fourteen documents that complete the bible's campaign. Written to the pattern
> [mission-sorrowgate.md](mission-sorrowgate.md) sets and the two built Chord documents continue:
...
> The reading of the count, per §8, hull by hull, and — in every ending but the last — "Go and be
> dry."
...
it extended. **This mission is specified and not built.** Its headline row is the campaign's
teaching target and the format has none of it: nothing outlives the match it was built in, so the
loss this mission is *about* is real inside eighteen minutes and gone at the close. Everything
else already ships, which makes that row a request rather than a blocker: **`chord-nineteen` is
buildable today, and what it cannot do is be remembered.**
