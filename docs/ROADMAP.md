...
([graphics-standards.md](graphics-standards.md) gate 7) the true-scale models failed at
survey zoom until the far-zoom scale answered it. The third is the parity rule — the Lid bleeds unrecoverable hull in
