...
assumption that a 250 nodule build is always a moment from affordable. For the Commune it
never is. Its composition cycle spends every purse it is handed on hulls of 30 to 105
nodules, and on seed 4000 its bank holds 250 on 4 observations of 2,500. Instrumented over
...
twice as many come off the slip. The last row is the cost, recorded rather than answered while the
freeze holds: a commander that pays for its defences fields a smaller army while it does, and
