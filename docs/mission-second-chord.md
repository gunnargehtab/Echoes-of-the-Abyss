...
| **Cross-mission Drift Health** | **Built** (#379). This is the fifth mission on `mouth-rim` inside one authored week and the third loud one, and it arrives as [campaign.md](campaign.md) §2 rule 5 promised — quieter, deader and more legible than the last, by exactly what the four tides before it did: the record keeps the rim's grid as the last close left it, and the room seeds this tide from it plus one flat recovery. The document does not depend on it; the 4 × 4 cells around the terraces simply are what two tides of eighty-SIG instrument and a raid made them |
...
| In-mission character speech, heard | **Heard** (#381) — the channel [mission-sorrowgate.md](mission-sorrowgate.md) §13 records, and the [audio-direction.md](audio-direction.md) §13 hail under every line. [mission-item-nine.md](mission-item-nine.md) §13 named the chair's transmission line as the bible's largest debt in a voice; this document matches it and does not raise it, because the two are the same button pressed for the same reason, and a hail pays neither |
