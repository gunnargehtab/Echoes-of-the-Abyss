...
- [Web Quality Audit](https://github.com/addyosmani/web-quality-skills/blob/main/skills/web-quality-audit/SKILL.md) <!-- LOCAL EDIT (not upstream): sibling skill not vendored here, so this points upstream instead of at ../web-quality-audit/SKILL.md — see .claude/VENDORED-SKILLS.md -->
